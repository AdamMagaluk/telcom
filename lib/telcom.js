...
TelcomClient.prototype.expressValidate = function(){
  ...
  return function(req,res,next){
    ...
    try {
      if(req._endPoint){
        req._telcomRequestUrl = req._endPoint + req.originalUrl;
        req._telcomRequestUrlNoQuery = req._endPoint + URL.parse(req.url).pathname;
      }else{
...
TelcomClient.prototype.onSms = function(handler){
  ...
  return function(req,res,next){
    ...
    return handler(req,res,sms,next);
  }
}
